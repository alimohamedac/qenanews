...
var checkSwitcherState = function() {
    ...
    $('[data-change="check-switchery-state-text-1"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-1"]').text('On');
        } else {
            $('[data-id="switchery-state-text-1"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-2"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-2"]').text('On');
        } else {
            $('[data-id="switchery-state-text-2"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-3"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-3"]').text('On');
        } else {
            $('[data-id="switchery-state-text-3"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-4"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-4"]').text('On');
        } else {
            $('[data-id="switchery-state-text-4"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-5"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-5"]').text('On');
        } else {
            $('[data-id="switchery-state-text-5"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-6"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-6"]').text('On');
        } else {
            $('[data-id="switchery-state-text-6"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-7"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-7"]').text('On');
        } else {
            $('[data-id="switchery-state-text-7"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-8"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-8"]').text('On');
        } else {
            $('[data-id="switchery-state-text-8"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-9"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-9"]').text('On');
        } else {
            $('[data-id="switchery-state-text-9"]').text('Off');
        }
    });
    $('[data-change="check-switchery-state-text-status"]').live('change', function() {
        if( $(this).prop('checked') == true ){
            $('[data-id="switchery-state-text-status"]').text('Active');
        } else {
            $('[data-id="switchery-state-text-status"]').text('Disabled');
        }
    });
};
